            ...
            <div className="row ">
                ...
                <div className="col-lg-6 p-5 d-flex justify-content-center">
                    <div className="main ">
                        ...
                        <div className="para pb-5">The GOAT Society community is unrivaled. Good energy day in and day out, &amp; pushing the needle of the NFT space. We are here to bring massive value to all of our community - Stay GOATED.</div><div className="milestone"><div className="point">
